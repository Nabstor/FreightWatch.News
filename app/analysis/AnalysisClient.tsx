        ...
        <div style={{ maxWidth: '760px', margin: '0 auto' }}>
          ...
          {loading ? (
            ...
            <div style={{ padding: '40px', background: '#f8f8f8', border: '1px solid #e2e2e2', textAlign: 'center' }}>
              <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '11px', color: '#0a1628', letterSpacing: '0.1em', marginBottom: '8px' }}>GENERATING BRIEFING</p>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', color: '#666' }}>Your daily analysis is being prepared. This page will update automatically.</p>
            </div>
          ) : error ? (
            <div style={{ padding: '40px', background: '#f8f8f8', border: '1px solid #e2e2e2', textAlign: 'center' }}>
